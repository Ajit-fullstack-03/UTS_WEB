...
const services = [
    ...
    },
    {
        ...
        bullets: [
            "Return filing for Corporations (S-corp & C-Corp), Partnership, and Trust entities",
            "Tax computation aligned with P&L and  balance sheet statements",
                ...
                <div className="srv-hero-main">
                    ...
                    <div className="srv-hero-visual srv-hero-visual--mobile-only">
                        <div className="srv-hero-img-frame">
                            <img src={usaHeroImg} alt="US Tax Filing and Compliance Solutions" className="srv-hero-img" />
                        </div>
                    </div>
                </div>
            </section>
